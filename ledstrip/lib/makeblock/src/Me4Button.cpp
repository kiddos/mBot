 ...
 *
 * \par Description
 * This file is a drive for 4 Button module, It supports Me-4 Button V1.0
 * device provided
 * by MakeBlock.
 *
 * \par Method List:
...
/**
 *  Alternate Constructor which can call your own function to map the Me4Button
 * to arduino port, \n
...
/**
 * Alternate Constructor which can call your own function to map the _KeyPin to
 * arduino port,
 * \param[in]
 ...
 * \par Others
 *    The key should periodically read, if it was delayed, It will affect the
...
uint8_t Me4Button::pressed(void) {
  ...
  // Division is slow in 8bit MCU, division should be replaced with right
  // shift.
