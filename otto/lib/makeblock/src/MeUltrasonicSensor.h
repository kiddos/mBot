 ...
 *
 * \par Copyright
 * This software is Copyright (C), 2012-2015, MakeBlock. Use is subject to
 * license \n
 * conditions. The main licensing options available are GPL V2 or Commercial:
 * \n
 *
...
#ifdef ME_PORT_DEFINED
  /**
   * Alternate Constructor which can call your own function to map the
   * ultrasonic sensor to arduino port,
