 ...
 * \par Installation
 *
 * Install the package in the normal way: unzip the distribution zip file to
 * the libraries \n
 ...
 * \par Donations
 *
 * This library is offered under GPLv2 license for those who want to use it
 * that way. \n
 * Additional information can be found at
 * http://www.gnu.org/licenses/old-licenses/gpl-2.0.html \n
 * We are tring hard to keep it up to date, fix bugs free and to provide free
 * support on our site. \n
 *
 * \par Copyright
 *
 ...
 * Rafael Lee       2015/09/02     3.1.0            Added some comments and
 * macros.
 * Lawrence         2015/09/09     3.2.0            Include some Arduino's
 * official headfiles which path specified.
 * Mark Yan         2015/11/02     3.2.1            fix bug on MACOS.
 * Mark Yan         2016/01/21     3.2.2            fix some library bugs.
 * Mark Yan         2016/05/17     3.2.3            add support for MegaPi and
 * Auriga Board.
 * Mark Yan         2016/07/27     3.2.4            fix some JIRA issue, add
 * PID motion for Megapi/Auriga on board encoder motor
 * </pre>
 *
 ...
 * Rafael Lee       2015/09/02         1.0.1            Added some comments and
 * macros. Fixed some bug and add some methods.
 * Lawrence         2015/09/09         1.0.2            Include some Arduino's
 * official headfiles which path specified.
 * Mark Yan         2015/11/02         1.0.3            fix bug on MACOS.
 * Mark Yan         2015/11/03         1.0.4            fix Segmentation
 * symbols error for file path.
 * </pre>
 */
...
#define MeDIRECT_MODE_INPUT(base, mask) \
  ((*((base) + 1)) &= ~(mask)), ((*((base) + 2)) |= (mask))  // INPUT_PULLUP
