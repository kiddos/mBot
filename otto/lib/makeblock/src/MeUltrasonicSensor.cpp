 ...
 *
 * \par Description
 * This file is a drive for Me ultrasonic sensor device, It supports ultrasonic
 * sensor
 ...
 * Mark Yan         2015/11/16     1.0.1            Increase 100us delay, avoid
 * ultrasonic read exception.
 * Mark Yan         2016/06/25     1.0.2            Modify Read mechanism of
 * ultrasonic waves.
 * </pre>
 *
...
/**
 * Alternate Constructor which can call your own function to map the ultrasonic
 * sensor to arduino port,
